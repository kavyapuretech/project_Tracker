...
require([ "esri/map", "esri/dijit/Search", "dojo/dom", "esri/dijit/Scalebar",
		"esri/layers/ArcGISDynamicMapServiceLayer", "esri/InfoTemplate",
		"esri/layers/FeatureLayer", "esri/dijit/BasemapGallery",
		"esri/dijit/Legend", "dojo/_base/array", "dojo/domReady!" ], function(
		Map, Search, dom, Scalebar, ArcGISDynamicMapServiceLayer, InfoTemplate,
		FeatureLayer, BasemapGallery, Legend, arrayUtils) {
	map1 = new Map("map", {
