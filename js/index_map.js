 var map1;
               ...
               require(["esri/map","esri/dijit/Search","dojo/dom", "esri/dijit/Scalebar","esri/layers/ArcGISDynamicMapServiceLayer", "esri/InfoTemplate","esri/layers/FeatureLayer","esri/dijit/BasemapGallery","esri/dijit/Legend",  "dojo/_base/array","dojo/_base/xhr", "dojo/domReady!"],
		function(Map,Search,dom,Scalebar,ArcGISDynamicMapServiceLayer,InfoTemplate,FeatureLayer,BasemapGallery,Legend,arrayUtils,xhr) {
                 map1 = new Map("map", {
...
var url = require.toUrl("dijit/form/test/widget.html");
xhr.get({
url: url,
load: function(html){
